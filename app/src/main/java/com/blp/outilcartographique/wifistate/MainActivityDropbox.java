...
/**
 * Created by Gildas on 01/03/2017.
 */
...
public class MainActivityDropbox extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!tokenExists()) {
            ...
            Intent intent = new Intent(MainActivityDropbox.this, LoginActivity.class);
    ...
    private boolean tokenExists() {
        SharedPreferences prefs = getSharedPreferences("com.polytech.ctv.outilcartographique.wifistate", Context.MODE_PRIVATE);
    ...
    public void onBackPressed (){
        Intent backAccueil = new Intent(MainActivityDropbox.this, Accueil.class);
