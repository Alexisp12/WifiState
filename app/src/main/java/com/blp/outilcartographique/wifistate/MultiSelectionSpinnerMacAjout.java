...
public class MultiSelectionSpinnerMacAjout extends Spinner implements
        DialogInterface.OnMultiChoiceClickListener
{

    public static String[] _items = null;
    public static boolean[] mSelection = null;

    public static ArrayAdapter<String> simple_adapter;

    //Constructeur du MultiSpinner
    public MultiSelectionSpinnerMacAjout(Context context)
    {
        super(context);
    ...
    public MultiSelectionSpinnerMacAjout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean performClick() {
        ...
        builder.setPositiveButton("Ajouter", new DialogInterface.OnClickListener() {
            ...
            {
                choixMacReseauExterne=new ArrayList<String>();
                for (int i = 0; i < getSelectedStrings().size(); i++) {
                    if (!choixMac.contains(getSelectedStrings().get(i))) {
                        choixMacReseauExterne.add(getSelectedStrings().get(i));
                        Log.d("AjoutMacRéseauExterne",getSelectedStrings().get(i).toString());
                    }
                }
