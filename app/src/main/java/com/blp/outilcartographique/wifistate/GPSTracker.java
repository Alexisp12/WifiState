...
/**
 * Created by Alexis on 02/01/2017.
 */
    ...
    public Location getLocation() {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "No network privder is enabled", Toast.LENGTH_SHORT);
                toast.show();
            } else {
                ...
                if (false) {  // Remplacer la condition par if(isNetworkEnabled) si on veut utiliser la localisation du Network
